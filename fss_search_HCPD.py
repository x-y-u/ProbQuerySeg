...
def main():
    atlas_base_path = "/media/UG3/xieyu/fiber_query/HCPD/Atlas_tck_in_person/"
    bundle_names = get_bundle_names()

    references_base_path = "/media/UG3/xieyu/fiber_query/HCPD/T1_un_reg/"

    whole_brain_base_path = "/media/UG3/xieyu/fiber_query/HCPD/tracking_results/"

    out_base_path = "/media/UG3/xieyu/fiber_query/HCPD/fiber_recognize_results/"
