...
def main():
    ...
    out_base_path = "/media/UG3/xieyu/tractography_generate/HCP/HCP_mask/"
    ...
    for sample_name in tqdm(sample_names):
        ...
        org_file_path = os.path.join(dwi_base_path, sample_name, f"T1w/T1w_acpc_dc_restore_brain.nii.gz")
        ...
        for bundle_name in tqdm(bundle_names):
            ...
            generate_mask(cur_tck_path, org_file_path, cur_out_path)
