...
def main():
    tck_base_path = "/media/UG3/xieyu/fiber_query/BTC/tracking_results/"

    mask_base_path = "/media/UG3/xieyu/fiber_query/BTC/population_multi_mask_in_person/"
    end_points_mask_base_path = "/media/UG3/xieyu/fiber_query/BTC/population_end_points_multi_mask_in_person/"

    extended_aparc_base_path = "/media/UG3/xieyu/fiber_query/BTC/extended_aparc/"
    ...
    for sample_name in tqdm(sample_names):
        ...
        if not os.path.exists(aparc_file_path):
            continue
        ...
        for tracking_type in tracking_types:
            ...
            for index, line_indices, end_points, cur_combo_points in tqdm(zip(range(len(cur_whole_brain_tck)), cur_bundle_indices,
                ...
                cur_class = get_single_fiber_class(line_indices, end_points, cur_combo_points, cur_mask, cur_end_points_mask, aparc_atlas,
                                                   bundle_names, combos)
