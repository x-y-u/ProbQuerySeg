...
def main():
    atlas_base_path = "/media/UG3/xieyu/fiber_query/HCPA/Atlas_tck_in_person/"
    bundle_names = get_bundle_names()

    references_base_path = "/media/UG3/xieyu/fiber_query/HCPA/T1_un_reg/"

    whole_brain_base_path = "/media/UG3/xieyu/fiber_query/HCPA/tracking_results/"
    ...
    for subject in subjects:
        ...
        for atlas_num in atlas_nums:
            if os.path.exists(os.path.join(cur_out_dir, f"reco_bundle_{atlas_num}_labels-{tracking_type}.npy")):
                continue
            ...
            np.save(os.path.join(cur_out_dir, f"reco_bundle_{atlas_num}_labels-{tracking_type}.npy"), results)
