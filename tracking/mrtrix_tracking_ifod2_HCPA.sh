...
freesurfer_base_dir="/media/UG3/xieyu/fiber_query/HCPA/freesurfer_out"

fod_base_dir="/media/UG3/xieyu/fiber_query/HCPA/tractseg_output"

mask_base_dir="/media/UG5/HCPA"

out_base_dir="/media/UG3/xieyu/fiber_query/HCPA/tracking_results"
